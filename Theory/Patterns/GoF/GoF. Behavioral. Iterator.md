...
- **`Flow`** — асинхронный итератор: те же «есть ли следующий элемент» и «дай следующий», но с приостановкой вместо блокировки. См. [[Flow]].
...
Связано: [[GoF patterns]], [[3 Sequence]], [[Flow]], [[Collections. Overview]]