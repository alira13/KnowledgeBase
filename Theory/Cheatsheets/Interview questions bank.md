...
https://medium.com/@MrAndroid/kotlin-%D0%B2%D0%BE%D0%BF%D1%80%D0%BE%D1%81%D1%8B-%D0%B8-%D0%BE%D1%82%D0%B2%D0%B5%D1%82%D1%8B-%D0%B4%D0%BB%D1%8F-%D1%81%D0%BE%D0%B1%D0%B5%D1%81%D0%B5%D0%B4%D0%BE%D0%B2%D0%B0%D0%BD%D0%B8%D1%8F-c34894c50786
Допы
...
**Ответы** на некоторые из этих вопросов вы можете найти в видео курсе [Kotlin](https://itvdn.com/ru/video/kotlin), а также статье [Kotlin vs Java: что лучше для Android-разработки?](https://itvdn.com/ru/blog/article/kotlin-vs-java) и вебинаре [Структуры данных в Java и Kotlin](https://itvdn.com/ru/webinars/description/datastructures-java-kotlin).
...
**Ответы** на эти вопросы вы найдёте в вебинаре [Структуры данных в Java и Kotlin](https://itvdn.com/ru/webinars/description/datastructures-java-kotlin).
...
**Ответы** на некоторые из этих вопросов вы найдете в видео курсе [SQLite. Базы данных в Android приложениях](https://itvdn.com/ru/video/sqlite-android) ([урок 2](https://itvdn.com/ru/video/sqlite-android/room-sqlite), [урок 3](https://itvdn.com/ru/video/sqlite-android/retrofit-room)).
...
**Ответы** на некоторые из этих вопросов вы найдете в видео курсах [Разработка приложений под Android. Базовый курс](https://itvdn.com/ru/video/android_essential) ([урок 2](https://itvdn.com/ru/video/android_essential/xml_oop)), [Android Углубленный](https://itvdn.com/ru/video/android-advanced) ([урок 9](https://itvdn.com/ru/video/android-advanced/android-web)).
...
**Ответы** на некоторые из этих вопросов вы найдете в видео курсе [Android Углубленный](https://itvdn.com/ru/video/android-advanced) ([урок 5](https://itvdn.com/ru/video/android-advanced/multithreaded-android)).
...
**Ответы** на некоторые из этих вопросов вы найдете в вебинаре [Что такое Java EE и Java Core](https://itvdn.com/ru/webinars/description/javaee-javacore) и видео курсе [Java Базовый](https://itvdn.com/ru/video/javaessential) ([урок 2](https://itvdn.com/ru/video/javaessential/classesobjects), [урок 4](https://itvdn.com/ru/video/javaessential/abstractclass), [урок 6](https://itvdn.com/ru/video/javaessential/staticnestedclass), [урок 7](https://itvdn.com/ru/video/javaessential/anonclassenumerationtypes), [урок 8](https://itvdn.com/ru/video/javaessential/exceptionhandling), [урок 9](https://itvdn.com/ru/video/javaessential/object)).
...
**Ответы** на некоторые из этих вопросов вы найдете в видео курсе [Создание пользовательских элементов управления в Android](https://itvdn.com/ru/video/custom-elements-android) ([урок 1](https://itvdn.com/ru/video/custom-elements-android)).
...
[](https://itvdn.com/ru/specialities/java-developer)[**Java Developer**](https://itvdn.com/ru/specialities/java-developer) [](https://itvdn.com/ru/specialities/android-dev)[**Android Developer**](https://itvdn.com/ru/specialities/android-dev) [](https://itvdn.com/ru/specialities/start)[**С чего начать?**](https://itvdn.com/ru/specialities/start)
...
**Ответы** на некоторые из этих вопросов вы найдете в видео курсах [Разработка приложений под Android. Базовый курс](https://itvdn.com/ru/video/android_essential) ([урок 2](https://itvdn.com/ru/video/android_essential/xml_oop), [урок 4](https://itvdn.com/ru/video/android_essential/logging), [урок 5](https://itvdn.com/ru/video/android_essential/menu), [урок 7](https://itvdn.com/ru/video/android_essential/service)), [Android Углубленный](https://itvdn.com/ru/video/android-advanced) ([урок 3](https://itvdn.com/ru/video/android-advanced/internet-filter), [урок 6](https://itvdn.com/ru/video/android-advanced/broadcast-receivers), [урок 9](https://itvdn.com/ru/video/android-advanced/android-web)), [Android User Interface](https://itvdn.com/ru/video/android-user-interface) ([урок 3](https://itvdn.com/ru/video/android-user-interface/recyclerview)), [Создание пользовательских элементов управления в Android](https://itvdn.com/ru/video/custom-elements-android) ([урок 9](https://itvdn.com/ru/video/custom-elements-android/databinding)).
...
**Ответы** на некоторые из этих вопросов вы найдете в видео курсе [Kotlin](https://itvdn.com/ru/video/kotlin).
...
**Ответы** на некоторые из этих вопросов вы найдете в видео курсах [Dependency Injection в Android-разработке](https://itvdn.com/ru/video/dependency-injection), [Основы работы с Git](https://itvdn.com/ru/video/git-basics).
...
**Ответы** на некоторые из этих вопросов вы найдете в видео курсах [Архитектура Android приложений](https://itvdn.com/ru/video/android-architecture) (урок 1-5), [Создание пользовательских элементов управления в Android](https://itvdn.com/ru/video/custom-elements-android) ([урок 4](https://itvdn.com/ru/video/custom-elements-android/solid-dagger2)), [SOLID принципы в Java](https://itvdn.com/ru/video/solid-java).
...
[](https://itvdn.com/ru/video/android_essential)[**Разработка приложений под Android. Базовый курс**](https://itvdn.com/ru/video/android_essential)[Андрей Бондаренко](https://itvdn.com/ru/video/android_essential)[  
  
](https://itvdn.com/ru/video/android-essential-ua)[**Android Базовый**](https://itvdn.com/ru/video/android-essential-ua)[Журавлев Артем](https://itvdn.com/ru/video/android-essential-ua)[  
  
](https://itvdn.com/ru/video/android-advanced)[**Android Углубленный**](https://itvdn.com/ru/video/android-advanced)[Андрей Бондаренко](https://itvdn.com/ru/video/android-advanced)
...
**Ответы** на некоторые из этих вопросов вы найдете в вебинаре [Что такое Java EE и Java Core](https://itvdn.com/ru/webinars/description/javaee-javacore) и видео курсе [Java Углубленный](https://itvdn.com/ru/video/java-professional) ([урок 5](https://itvdn.com/ru/video/java-professional/work-with-strings)).
...
**Ответы** на некоторые из этих вопросов вы найдете в видео курсах [Разработка приложений под Android. Базовый курс](https://itvdn.com/ru/video/android_essential) ([урок 4](https://itvdn.com/ru/video/android_essential/logging), [урок 7](https://itvdn.com/ru/video/android_essential/service)), [Android Углубленный](https://itvdn.com/ru/video/android-advanced) ([урок 6](https://itvdn.com/ru/video/android-advanced/broadcast-receivers), [урок 8](https://itvdn.com/ru/video/android-advanced/components-ui)), [Создание пользовательских элементов управления в Android](https://itvdn.com/ru/video/custom-elements-android) ([урок 9](https://itvdn.com/ru/video/custom-elements-android/databinding)).
...
**Ответы** на некоторые из этих вопросов вы найдете в видео курсе [Unit тестирование для Android разработчиков](https://itvdn.com/ru/video/unit-test-android).
...
[](https://itvdn.com/ru/webinars/description/it-during-war)[**IТ в период войны: как найти первую работу**](https://itvdn.com/ru/webinars/description/it-during-war)[Ирина Тытенко](https://itvdn.com/ru/webinars/description/it-during-war)[  
  
](https://itvdn.com/ru/webinars/description/android-trends-22)[**Тренды Android разработки в 2022 году.**](https://itvdn.com/ru/webinars/description/android-trends-22)[Бондаренко Андрей](https://itvdn.com/ru/webinars/description/android-trends-22)[  
  
](https://itvdn.com/ru/webinars/description/android-dev-approaches)[**Разработка под Android. Современные подходы и перспективы.**](https://itvdn.com/ru/webinars/description/android-dev-approaches)[Евгений Мыца](https://itvdn.com/ru/webinars/description/android-dev-approaches)
...
**Ответы** на некоторые из этих вопросов вы найдете в видео курсе [Архитектура Android приложений](https://itvdn.com/ru/video/android-architecture).
...
Kotlin  
1. Массивы в Kotlin, IntArray vs Array<Int> in Kotlin  
Какие виды массивов с базовыми классами (String, Int) есть в Котлин? В чём между ними разница? Сравнение массивов.  
2. Data Class  
1.1. Ограничения  
1.2. Как можно сделать так, чтобы дата класс создавался с пустым конструктором?  
1.3. Может ли дата класс наследоваться от другого класса?  
1.4. Можно ли написать в джава аналог дата класса котлин, опиши как это сделать.  
3. Inline value classes  
4. Sealed Class  
Отличие от enum  
5. Any, Nothing, Unit  
6. Primary vs Secondary constructor  
7. companion object  
8. Interface Closeable  
9. Задача с доступом к ресурсу из разных корутин  

**[https://github.com/Kotlin/kotlinx.coroutines/blob/master/kotlinx-coroutines-core/jvm/test/guide/example-sync-01.kt](https://github.com/Kotlin/kotlinx.coroutines/blob/master/kotlinx-coroutines-core/jvm/test/guide/example-sync-01.kt)**
...
Два метода, которые заставляют View перерисовываться  
Методы invalidate() и requestLayout()  
Метод onSizeChanged()  
Метод onTouchEvent()  
В андроид приложении при авторизации  
12. Что такое bundle и что туда можно сохранять, что будет если он переполнится?  
13. RecyclerView изменение списка и оптимальная его перерисовка. DiffUtill что это и как его использовать? DiffUtill callback зачем там 2 метода: areItemsTheSame и areContentsTheSame  
14. Хранение паролей в андроид приложении  
...
1. Что такое ООП, принципы ООП
2. Какие минусы у ООП

### Джава/Котлин

1. Какие есть коллекции в джава, их различие, сложность удаления, вставки, получение по индексу.
2. Может ли быть разным хэшкод у объектов, для которого equals возвращает true.
3. В чем отличие примитивных типов данных от ссылочных?
4. Как устроена память в джава?
5. Как работает gc?
6. Что такое дженерики и зачем они нужны? Что такое стирание типов?
7. В чем преимущества kotlin по сравнению с java?
8. Как компилируются базовые типы в котлин в байткод?
9. Рассказать про null-safety
10. Для чего нужны sealed классы, в чем различие между sealed классом и интерфейсом
11. Что такое data классы?
12. Что такое companion object?
13. Что такое модификатор lateinit?
14. Что такое платформенный тип данных?
15. Что такое scope функции, какие есть, в чем их отличие?
16. Что такое flow, какие бывают?
17. В чем различие shared flow и state flow?

### Многопоточность

1. Зачем нужна многопоточность? Какие сложности в многопоточном программировании?
2. Варианты реализации многопоточности в Android
3. Что такое корутины? Чем они лучше обычных потоков? Как устроен этот механизм?

### Архитектура

1. Что такое чистая архитектура? Зачем она нужна? Какие паттерны ты знаешь?
2. Принципы Solid и краткое описание
3. Какую роль выполняет вью модель в паттерне MVVM
4. Можно ли создать вью модель просто через вызов конструктора. Почему нет?

### Android

1. Основные компоненты андроид приложения и их краткое описание
2. Жизненный цикл активити
3. Какие методы жизнненого цикла активити вызовутся, если на главном экране приложения нажать кнопку назад
4. Что такое изменение конфигурации и что происходит при них с активити?
5. Зачем нужны фрагменты и в чем преимущество подхода сингл активити?
6. Что такое контекст?
7. Ресайклер вью, что такое, из чего состоит, как создать?
8. Способы улучшения производительности ресайклер вью.
9. Как перерисовать только одну вью в элементе ресайклер вью?
10. Можно ли передавать контекст активити в другие классы/методы? Чем это черевато? Что делать, если мне нужно сохранить ссылку на активити в классе апликейшен?
11. Что такое инъекция зависимостей, какие типы бывают, для чего используется?

  

  

Не ответил про diffutil,

про recyclerview не все рассказал,

про жизненный цикл view напутал,

не решил задачу по корутинам, причем предположил решение которое даже в примере было разобрано как ошибочное и почему оно было ошибочным 😁🤦‍♂️

еще не ответил про inline классы

Разница между IntArray и Array<Int>

У Котлина свой набор типов _kotlin.Int_, _kotlin.Long_ и т.д. И на первый взгляд может показаться, что создание объекта происходит всегда. Однако это не так. Базовые классы в стандартной библиотеке Котлина виртуальные. Это значит, что сами классы существуют только на этапе написания кода, дальше компилятор транслирует их на целевые классы платформы, в частности для JVM _kotlin.Int_ транслируется в _int_.

Kotlin-компилятор где это возможно старается использовать java примитивы, в остальных случаях ссылочные классы.

Non-null-типы компилятор котлина траслирует в примитивные Java классы платформы

_Null_-типы Котлин транслирует уже в ссылочные, т.е. _kotlin.Int? -> java.lang.Integer_

### Kotlin — точечные вопросы

1. Назови методы `Any`/`Object`. → `equals`, `hashCode`, `toString`; у Java-`Object` ещё `wait`, `notify`, `notifyAll`, `getClass`, `clone`, `finalize`. См. [[Classes. toString, equals, hashCode, copy]].
2. Может ли `data class` наследоваться? → сам может наследовать `open`/`abstract`-класс, но быть родителем не может (он `final`). И обязан иметь хотя бы одно свойство в первичном конструкторе.
3. Может ли `companion object` наследоваться от класса? Можно ли написать для него функцию-расширение? → да и да; расширения для `Companion` часто используют в тестах и для фабрик.
4. Почему `addAll` небезопасен в Java и при чём тут PECS? → сигнатура `Collection<? super T>` (consumer → super); без wildcard в коллекцию можно было бы положить неверный тип. См. [[Generics. Variance (in, out)]].
5. Почему `forEach` позволяет нелокальный `return`? → это inline-функция, тело лямбды встраивается в вызывающий метод, поэтому `return` выходит из внешней функции; для выхода только из лямбды — `return@forEach`.
6. Почему `if (x != null)` не даёт smart cast для свойства класса? → между проверкой и использованием значение может изменить другой поток или другой модуль; smart cast работает для локальных `val` и неизменяемых свойств. См. [[Types. 0 Nullable, not-null]].

  

Для массивов из примитивов есть свои аналоги в Котлине, например, _IntArray -> int[]_ и т.д. Для всех остальных типов используется обобщенный класс Array -> T